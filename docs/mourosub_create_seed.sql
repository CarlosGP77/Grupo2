...
(1, 'Puerto Deportivo Marina del Cantábrico', 'Ubicación principal para salidas y bautismos.'),
(2, 'Cabo Mayor', 'Zona ideal para inmersiones de nivel medio.'),
(3, 'Bahía de Santander', 'Área protegida con gran visibilidad.'),
(4, 'Isla de Mouro', 'Punto emblemático para inmersiones avanzadas.');

-- Inmersiones
INSERT INTO inmersiones (id_inmersion, nombre, contenido, datos, dificultad, ubicacion) VALUES
(1, 'Inmersión Costa Norte', 'Recorrido guiado por fondo rocoso y fauna local.', 'Duración aproximada: 40 minutos', 'Baja', 1),
(2, 'Inmersión Arrecife Verde', 'Exploración de un fondo con praderas marinas.', 'Requiere certificación básica', 'Media', 2),
(3, 'Inmersión Noche Azul', 'Inmersión nocturna con foco en orientación y seguridad.', 'Salida especial con instructor', 'Alta', 3),
(4, 'Inmersión Isla de Mouro', 'Ruta técnica en una de las zonas más conocidas de la bahía.', 'Solo buceadores avanzados', 'Alta', 4);
...
(1, 3, 1, 1, '2026-05-15 09:00:00', '2026-07-15 17:00:00', 299.99),
(2, 4, 2, 2, '2026-06-01 09:00:00', '2026-08-01 17:00:00', 349.99),
(3, 5, 3, 3, '2026-05-20 09:00:00', '2026-08-20 17:00:00', 399.99);
